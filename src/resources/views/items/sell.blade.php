...
@section('content')
    <div class="sell">
        <div class="sell__inner">
            ...
            <form class="sell-form" action="{{ route('items.sell.store') }}" method="POST" enctype="multipart/form-data"
                novalidate>
                @csrf
                        ...
                        <div class="sell-category">
                            ...
                            @foreach ($categories as $cat)
                                ...
                                <label class="sell-category__chip {{ $checked ? 'is-active' : '' }}">
                                    <input class="sell-category__checkbox" type="checkbox" name="categories[]"
                                        value="{{ $cat }}" {{ $checked ? 'checked' : '' }}>
                ...
                <section class="sell-section">
                    ...
                    <div class="sell-field">
                        ...
                        <div class="sell-price">
                            ...
                            <input class="sell-price__input" type="number" id="price" name="price"
                                value="{{ old('price') }}">
                        </div>
